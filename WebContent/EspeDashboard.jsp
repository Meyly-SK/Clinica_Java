        ...
        <div class="row justify-content-center align-content-center">
            ...
            <div class="col-4 text-right barra">
                <ul class="navbar-nav mr-auto">
                	<li>
                	Usuario: <small>${Especialista.nom_espe}</small>
                	</li>
                    <li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbar-dropdown">
                            ...
                            <a class="dropdown-item menuperfil cerrar" href="ServletEspecialista?tipo=perfil&cod=${Especialista.id_espe}"><i class="fas fa-sign-out-alt m-1"></i>Configuracion
                            </a>
                        </div>
                    </li>
                </ul>
