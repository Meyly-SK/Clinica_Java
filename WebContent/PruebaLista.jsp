...
<%
  ...
  %>
   ...
   <a href="registrarPrueba.jsp"> + Nuevo Registro</a>
   ...
   <table border="2" align="center" width="75%">
      ...
      <tr>
         ...
         <td colspan="2" align="center"><a
				href="ServletPrueba?tipo=buscar&cod=<%=a.getId_prueba()%>"> <img
					title="Editar" src="img/editar3.png"></a>
					<a
				href="ServletPrueba?tipo=eliminar&cod=<%=a.getId_prueba()%>"> <img
