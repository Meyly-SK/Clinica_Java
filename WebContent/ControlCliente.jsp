...
<%
  ...
  %>
   ...
   <h2 align="center">CONTROL DE CLIENTES</h2>
   ...
   <table border="2" align="center" width="75%">
      ...
      <tr>
         ...
         <td><%=a.getApe_cliente()%></td>
                 
         <td><%=a.getTel_cliente()%></td>
         
         <td colspan="2" align="center"><a
				href="ServletCliente?tipo=buscar&cod=<%=a.getId_cliente()%>"> <img
					title="Editar" src="img/editar3.png"></a>
					<a
				href="ServletCliente?tipo=eliminar&cod=<%=a.getId_cliente()%>"> <img
