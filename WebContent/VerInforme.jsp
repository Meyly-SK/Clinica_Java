...
<body>
	...
	<form action="ServletInforme?tipo=actualizar" id="frmactualizar"
		...
		<input name="txt_cod" readonly
			...
			<input value="${dato.nom_cliente}" readonly>
			<br>
     	<label>ID Cliente</label>
				<input type="text" value="${ dato.id_cliente}">
				<br>
				<label>ID Especialista</label>
				<input type="text" name="txt_espe" value="${requestScope.Informe.nom_espe}" readonly>
				<br>
				<label>Causa</label>
				<input type="text" name="txt_causa" value="${requestScope.Informe.causa_info}" readonly>
				<br>
				<label>Sintoma</label>
				<input type="text" name="txt_sintoma" value="${requestScope.Informe.sintoma_info}" readonly>
				<br>
				<label>Fecha Sintoma</label>
				<input type="date" name="txt_fecSin" value="${requestScope.Informe.fec_sintoma}" readonly>
				<br>
				<label>Diagnostico</label>
				<input type="text" name="txt_diag" value="${requestScope.Informe.diag_info}" readonly>
				<br>
				<label>Fecha Diagnostico</label>
				<input type="date" name="txt_fecDiag" value="${requestScope.Informe.fec_diag}" readonly>
				<br>
				<label>Observacion</label>
				<textarea name="txt_obs" readonly></textarea>
				<br>
	</form>
