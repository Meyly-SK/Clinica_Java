...
<%
  	List<CitaDTO> da = (List<CitaDTO>) request.getAttribute("data");
  %>
   ...
   <a href="registrarCita.jsp"> + Nuevo Registro</a>
   ...
   <table border="2" align="center" width="75%">
      ...
      <tr>
         ...
         <td colspan="2" align="center"><a
				href="ServletCita?tipo=buscar&cod=<%=a.getId_cita()%>"> <img
					title="Editar" src="img/editar3.png"></a>
					<a
				href="ServletCita?tipo=eliminar&cod=<%=a.getId_cita()%>"> <img
