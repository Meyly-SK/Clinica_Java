...
%>
				...
				<br>
				<label>Causa</label>
				<input type="text" value="${Prueba.cau_prueba}"name="txt_causa">
				<br>
				<label>Fecha</label>
				<input type="date" value="${Prueba.fec_prueba}"name="txt_fec">
				<br>
				<label>Observacion</label>
				<input type="text" value="${Prueba.obs_prueba}"name="txt_obs">
				<br>		
