...
%>
    <div class="login-principal">
        <h2>CLIENTE</h2>
            ...
            <form class="frm-box" action="ServletCliente?tipo=sesion" name="frmsesion" method="post"> 
    ...
    <button id="btnIntranet" onclick="location.href='LoginEspecialista.jsp'">ESPECIALISTA</button>  
