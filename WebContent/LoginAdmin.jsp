...
%>
    <div class="login-principal">
        <h2>ADMINISTRADOR</h2>
            ...
            <form class="frm-box" action="ServletAdmin?tipo=sesion" name="frmsesion" method="post"> 
    ...
    <button id="btnIntranet" onclick="location.href='LoginCliente.jsp'">CLIENTE</button>
</body>
</html>